	...
	*new {  | outBus = 0, modularOut = 2, modularIn = 2, relGroup, addAction = 'addToHead' |
	...
	prInit { | modularOut = 2, modularIn = 2 |
		...
		server.waitForBoot {
			...
			distortion = Decapitator.newStereo(modularOut.inBus, relGroup: group, addAction: \addToHead);
	...
	prSetInitialParameters {
		...
		distortion.postEQ.setLowPassCutoff(12000);
		distortion.mixer.setPreVol(0);
		*/
		distortion.loadPreset('darkness');
