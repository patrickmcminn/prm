...
AudioSystem {
  ...
  var hardwareOut, <systemMixer, <utilityMixer;
  var <irLibrary;
  ...
  *new { | numOutputs = 2 |
  ...
  prInit { |numOutputs|
    ...
    server.waitForBoot {
      ...
      utilityMixer = IM_Mixer.new(4, this.audioIn,
        reverb.inBus, granulator.inBus, modularSend.inBus, delay.inBus, false, procGroup, \addToHead);
      while({ try { utilityMixer.isLoaded } != true }, { 0.001.wait; });

      pickup = IM_Mixer_1Ch.new(utilityMixer.chanStereo(0), relGroup: procGroup, addAction: \addToHead);
      ...
      microphone = IM_Mixer_1Ch.new(utilityMixer.chanStereo(1), relGroup: procGroup, addAction: \addToHead);
      ...
      modular = IM_Mixer_1Ch.new(utilityMixer.chanStereo(2), relGroup: procGroup, addAction: \addToHead);
      ...
      moog = IM_Mixer_1Ch.new(utilityMixer.chanStereo(3), relGroup: procGroup, addAction: \addToHead);
      ...
      utilityMixer.mute(0); utilityMixer.mute(1); utilityMixer.mute(2); utilityMixer.mute(3);
