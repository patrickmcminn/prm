...
TrumpetNebula : IM_Processor {
  ...
  *newStereo {
    | outBus, send0Bus = nil, send1Bus = nil, send2Bus = nil, send3Bus = nil, relGroup = nil, addAction = 'addToTail' |
    ^super.new(1, 1, outBus, send0Bus, send1Bus, send2Bus, send3Bus, relGroup: relGroup, addAction: addAction).prInitStereo;
  }
  ...
  */
  ...
  prInitMono { | outBus, amp = 1, relGroup = nil, addAction = 'addToTail' |
  ...
  prInitStereo { | outBus, amp = 1, relGroup = nil, addAction = 'addToTail' |
    var server = Server.default;
    server.waitForBoot {
      isLoaded = false;
      this.prAddSynthDef;
  ...
  */
  ...
  prAddSynthDef {
    ...
    SynthDef(\prm_trumpetDefault_Stereo, {
      |
      inBus = 0, outBus = 0, amp = 1, balance = 0, inputMute = 1, mute = 1,
      pitchShift = 0,
      lowGain = -6, highGain = -6, lowFrequency = 250, highFrequency = 2500,
