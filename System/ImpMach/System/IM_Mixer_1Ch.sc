...
+ IM_Mixer_1Ch {
  ...
  setSendVol { |sendNum = 0, db = 0| masterChan.setSendVol(sendNum, db) }
  setSendPre { masterChan.setSendPre }
  setSendPost { masterChan.setSendPost }
  ...
  mapSend2Amp { | bus | masterChan.mapSend2Amp(bus) }
  mapSend3Amp { | bus | masterChan.mapSend3Amp(bus) }
