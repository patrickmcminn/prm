...
+ APC40Mk2 {
	...
	turnAllGridOff { | bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridOff(col, row, bank, page); }); });
	}
	turnAllGridWhite { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridWhite(col, row, brightness, bank, page); }); });
	}
	turnAllGridRed { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridRed(col, row, brightness, bank, page); }); });
	}
	turnAllGridYellow { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridYellow(col, row, brightness, bank, page); }); });
	}
	turnAllGridYellowGreen { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridYellowGreen(col, row, brightness, bank, page); }); });
	}
	turnAllGridGreen { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridGreen(col, row, brightness, bank, page); }); });
	}
	turnAllGridCyan { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridCyan(col, row, brightness, bank, page); }); });
	}
	turnAllGridLightBlue { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridLightBlue(col, row, brightness, bank, page); }); });
	}
	turnAllGridBlue { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridBlue(col, row, brightness, bank, page); }); });
	}
	turnAllGridPurple { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridPurple(col, row, brightness, bank, page); }); });
	}
	turnAllGridMagenta { | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridMagenta(col, row, brightness, bank, page); }); });
	}
	turnAllGridPink{ | brightness = 2, bank = 'active', page = 'active' |
		8.do({ | col | 5.do({ | row | this.turnGridPink(col, row, brightness, bank, page); }); });
	}
